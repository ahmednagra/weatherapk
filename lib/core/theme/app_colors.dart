...
/// Central colour tokens for the dark premium meteorological console look.
class AppColors {
  AppColors._();
  ...
  static final Color textMuted = const Color(0xFFE8F4FF).withOpacity(0.45);
  static final Color textFaint = const Color(0xFFE8F4FF).withOpacity(0.30);
  ...
  static final Color cyanFill = rainCyan.withOpacity(0.08);
  static final Color amberFill = stormAmber.withOpacity(0.08);
  static final Color greenFill = growthGreen.withOpacity(0.08);
  static final Color coralFill = dangerCoral.withOpacity(0.08);
}
